# How to Test MACRAW Example



## Step 1: Prepare software

The following serial terminal program is required for MACRAW example test, download and install from below link.
...
## Step 3: Setup MACRAW Example

To test the MACRAW example, minor settings shall be done in code.
...
If you want to test with the MACRAW example using SPI DMA, uncomment USE_SPI_DMA.
...
2. Setup network configuration such as IP in 'w5x00_dhcp_dns.c', which is the MACRAW example in 'RP2040-HAT-C/examples/dhcp_dns/' directory.
...
1. After completing the MACRAW example configuration, click 'build' in the status bar at the bottom of Visual Studio Code or press the 'F7' button on the keyboard to build.
...
5. If the MACRAW example works normally on Raspberry Pi Pico, W5100S-EVB-Pico or W5500-EVB-Pico, you can see the network information, IP automatically assigned by DHCP of Raspberry Pi Pico, W5100S-EVB-Pico or W5500-EVB-Pico and the IP get from the domain name.
